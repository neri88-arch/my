...
sudo pacman -S --needed --noconfirm kitty unzip polkit-kde-agent qemu-desktop virt-viewer uv bat eza zoxide gwenview mpv btop qutebrowser
...
sudo pacman -Rsn --noconfirm vim vim-runtime alacritty waybar htop cat ls
